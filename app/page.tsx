            ...
            <GlassmorphicCard>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-zinc-800 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-zinc-800 flex items-center justify-center flex-shrink-0">
                    <Github className="h-4 w-4 md:h-5 md:w-5 text-purple-400" />
                  </div>
                  <div className="min-w-0 flex-1">
              ...
              <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-zinc-800">
                <h4 className="text-base md:text-lg font-medium mb-3 md:mb-4">Current Status</h4>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-green-500 animate-pulse flex-shrink-0"></div>
                  <span className="text-sm md:text-base">Available for freelance work and full-time opportunities</span>
                </div>
              </div>
            </GlassmorphicCard>
